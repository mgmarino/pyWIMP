...
# Now get the index of the minimum ll above model_amplitude of 0
...
for var_cache in sendbuf:
    ...
    curve.Draw("APL")
    c1.Update()
    test = model_normal.getVal()
    print bf, upper, lower, bound, test
    print "Unbound: ", (upper >= test and lower <= test)
    print "Bound: ", (bound >= test and lower <= test)
    raw_input("E")
